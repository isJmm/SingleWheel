...
#define DOT_MATRIX_SCREEN_SR0_PIN       (P11_10)
#define DOT_MATRIX_SCREEN_SR1_PIN       (P11_9)
#define DOT_MATRIX_SCREEN_SR2_PIN       (P11_6)
#define DOT_MATRIX_SCREEN_SR3_PIN       (P11_3)                 // 摩托组可以将引脚定义修改为P33_8
#define DOT_MATRIX_SCREEN_SR4_PIN       (P11_2)
#define DOT_MATRIX_SCREEN_SR5_PIN       (P13_3)
#define DOT_MATRIX_SCREEN_SR6_PIN       (P13_2)
